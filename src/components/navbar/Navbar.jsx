...
const Navbar = () => {
  ...
  const likeCount = likedProduct.length
    ...
    <div>
      <nav
        ...
        <ul className="w-full flex justify-center items-center gap-4">
          <li
            className="font-['Lato'] flex justify-center items-center gap-2 py-1 px-3 bg-blue-50 rounded-lg shadow-md">
            <input className="outline-none bg-transparent" type="text" placeholder="Search..."/> <BiSearchAlt/></li>
          <li><Link className="relative" to="/liked-products">
            {
              likeCount ? <><FaHeart className="text-red-500"/><span
                className="w-5 h-5 flex font-semibold items-center justify-center text-white text-xs -top-3 -right-3  bg-rose-500 absolute rounded-full">{likeCount}</span></> : <><FaRegHeart className="text-red-500"/></>
            }
          </Link></li>
          <li><Link className="relative" to="/carts"><SlBasket/>
            {
              cartCount ? <span
                className="w-5 h-5 flex font-semibold items-center justify-center text-white text-xs -top-3 -right-3  bg-rose-500 absolute rounded-full">{cartCount}</span> : <></>
            }
          </Link></li>
        </ul>
      </nav>
